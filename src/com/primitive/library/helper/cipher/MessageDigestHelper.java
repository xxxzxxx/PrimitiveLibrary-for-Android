...
public class MessageDigestHelper {
	...
	public static String getDigestBase64(Algorithm algorithm, byte[] message) throws NoSuchAlgorithmException{
		byte[] digest = getDigest(algorithm, message);
		String encode = Base64.encodeToString(digest, Base64.DEFAULT);
		return encode;
	}
	public static byte[] getDigest(Algorithm algorithm, byte[] message) throws NoSuchAlgorithmException{
